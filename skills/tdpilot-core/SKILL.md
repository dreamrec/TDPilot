...
name: tdpilot-core
description: >
  Core patching discipline for TDPilot v1.4.1 — the AI assistant inside TouchDesigner.
...
# TDPilot Core v1.4.1 — Patching Discipline (92 tools)
...
## Complete Tool Surface — v1.4.1 (92 tools, 7 resources)
