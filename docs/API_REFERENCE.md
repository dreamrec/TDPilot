...
> TDPilot v2.0.3 | 112 tools | Hand-maintained reference — the canonical source of truth is the `@mcp.tool` registrations under `src/td_mcp/registry/`. If this document and the code disagree, the code wins.
