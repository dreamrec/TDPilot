...
def _build_manifest(version: str) -> dict:
    ...
    return {
        ...
        "version": version,
        "description": "AI copilot for TouchDesigner — 101 MCP tools for live node graph control, parameter management, diagnostics, safety, streaming, technique memory, knowledge corpus, and typed patch sessions.",
        "long_description": (
