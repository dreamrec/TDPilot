...
- `REAL_WORLD_MCP_MANUAL.md` - an alternative plain-language manual for someone who has never used MCP before and wants a realistic way to use TDPilot well.
...
3. `REAL_WORLD_MCP_MANUAL.md`
4. `MEMORY_BRAIN_MANUAL.md`
5. `HONEST_OPINION.md`
6. `WHAT_TO_FIX.md`
...
- `uv run --extra dev pytest tests/ -q` -> 342 passed
