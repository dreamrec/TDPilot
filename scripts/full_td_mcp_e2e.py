...
`td_component/mcp_server.tox` loaded.
...
class E2ESuite:
    ...
    async def _step_event_tools(self) -> None:
        ...
        if not found:
            raise TestWarning(
                "No new chop_change events observed for subscribed path. Check ws_client URL, active state, and event_emitter wiring in mcp_server.tox."
            )
