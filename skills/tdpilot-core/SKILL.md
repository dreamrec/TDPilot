...
name: tdpilot-core
description: >
  Core patching discipline for TDPilot v1.6.8 — the AI assistant inside TouchDesigner.
...
# TDPilot Core v1.6.8 — Patching Discipline (103 tools)
...
## Complete Tool Surface — v1.6.8 (103 tools, 6 resource templates + 1 static resource)
