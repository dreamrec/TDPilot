...
AI copilot for TouchDesigner — 101 tools for full live control via MCP, with technique memory, knowledge corpus, POPx inspection, project lifecycle control, and custom parameter authoring.
