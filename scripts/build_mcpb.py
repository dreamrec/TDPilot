...
def _build_manifest(version: str) -> dict:
    ...
    return {
        ...
        "version": version,
        "description": "AI copilot for TouchDesigner — 97 MCP tools for live node graph control, parameter management, diagnostics, safety, streaming, technique memory, and typed patch sessions.",
        "long_description": (
            "TDPilot is a production-grade MCP server for TouchDesigner. "
            "It exposes 97 tools that let an AI agent inspect, build, wire, "
