...
name: tdpilot-core
description: >
  Core patching discipline for TDPilot v1.5.1 — the AI assistant inside TouchDesigner.
...
# TDPilot Core v1.5.1 — Patching Discipline (97 tools)
...
## Complete Tool Surface — v1.5.1 (97 tools, 6 resource templates + 1 static resource)
