"""
TDPilot — Build and export a reusable `mcp_server.tox`
======================================================
...
# If empty, auto-resolve to: <repo_root>/td_component/mcp_server.tox
EXPORT_TOX_PATH = ""
...
def _resolve_export_path(repo_root):
    if EXPORT_TOX_PATH:
        ...
        out_path = os.path.join(repo_root, "td_component", "mcp_server.tox")
