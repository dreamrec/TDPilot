...
name: tdpilot-core
description: >
  Core patching discipline for TDPilot v1.4.3 — the AI assistant inside TouchDesigner.
...
# TDPilot Core v1.4.3 — Patching Discipline (92 tools)
...
## Complete Tool Surface — v1.4.3 (92 tools, 6 resource templates + 1 static resource)
