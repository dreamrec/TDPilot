...
name: tdpilot-core
description: >
  Core patching discipline for TDPilot v2.1.0 — the AI assistant inside TouchDesigner.
...
# TDPilot Core v2.1.0 — Patching Discipline (114 tools)
...
## Complete Tool Surface — v2.1.0 (114 tools, 9 resource templates + 4 static resources)
